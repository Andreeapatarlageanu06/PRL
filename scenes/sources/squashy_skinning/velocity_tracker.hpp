...
struct skeleton_previous_t {

    void add(vcl::buffer<joint_geometry> const& skeleton);
    vcl::buffer<joint_geometry> get_skeleton(int k) const;

    vcl::buffer<vcl::buffer<joint_geometry> > data;
};
...
struct rotation_tracker
{
    ...
    vcl::buffer<vec3> saved_rotation;
};
